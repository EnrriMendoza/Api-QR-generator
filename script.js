document.addEventListener("DOMContentLoaded", () => {
        ...
        codeReader.decodeFromVideoDevice(null, qrReader, (result, err) => {
          if (result && !scanned) {
            ...
            try {
              ...
              if (!cdcid) {
                alert("El QR escaneado no contiene un CDC válido.");
                return;
              }
  
              console.log("CDC capturado:", cdcid);
  
              enviarCDC(cdcid, qrId, sessionId);
              codeReader.reset();
            ...
            Tesseract.recognize(imageData, 'spa', { logger: m => console.log(m) })
              .then(({ data: { text } }) => {
                ...
                if (match) {
                  ...
                  console.log("CDC detectado (OCR):", cdcid);
                  enviarCDC(cdcid, qrId, sessionId);
  ...
  function enviarCDC(cdcid, qrId, sessionId) {
    ...
    .then(data => {
      console.log("✅ CDC enviado correctamente:", data);
